	...
	<script type="text/template" id="treeTableTpl">
		<tr id="{{row.id}}" pId="{{pid}}">
			<shiro:hasPermission name="payinfo:payInfo:edit"><td>
   				<a href="${ctx}/payinfo/payInfo/form?id={{row.id}}">修改</a>
				<a href="${ctx}/payinfo/payInfo/delete?id={{row.id}}" onclick="return confirmx('确认要删除该支付信息功能及所有子支付信息功能吗？', this.href)">删除</a>
				<a href="${ctx}/payinfo/payInfo/form?parent.id={{row.id}}">添加下级支付信息功能</a> 
