	...
	<script type="text/template" id="treeTableTpl">
		<tr id="{{row.id}}" pId="{{pid}}">
			<shiro:hasPermission name="orderinfo:orderInfo:edit"><td>
   				<a href="${ctx}/orderinfo/orderInfo/form?id={{row.id}}">修改</a>
				<a href="${ctx}/orderinfo/orderInfo/delete?id={{row.id}}" onclick="return confirmx('确认要删除该订单信息功能及所有子订单信息功能吗？', this.href)">删除</a>
				<a href="${ctx}/orderinfo/orderInfo/form?parent.id={{row.id}}">添加下级订单信息功能</a> 
